...
#define MyAppVersion "4.0.21"
#define MyAppDisplayVersion "1.2.2"
...
OutputBaseFilename=Xomacito-1.2.2-Update-Light
...
VersionInfoVersion=4.0.21.0
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion={#MyAppDisplayVersion}
VersionInfoDescription=Xomacito 1.2.2 - Actualización ligera
...
Source: "{#ProjectRoot}\bin\ytdlp\*"; DestDir: "{app}\_internal\bin\ytdlp"; Flags: ignoreversion
