...
#define MyAppDisplayVersion "1.2.5"
...
OutputBaseFilename=Xomacito-1.2.5-Update-Light
...
VersionInfoVersion=4.0.24.0
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion={#MyAppDisplayVersion}
VersionInfoDescription=Xomacito 1.2.5 - Actualización ligera
