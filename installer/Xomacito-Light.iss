...
#define MyAppDisplayVersion "1.2.6"
...
OutputBaseFilename=Xomacito-1.2.6-Update-Light
...
VersionInfoVersion=4.0.25.0
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion={#MyAppDisplayVersion}
VersionInfoDescription=Xomacito 1.2.6 - Actualización ligera
