...
class BatchDownloadTab(ctk.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        subfolder_tooltip_text = "Guarda todos los archivos en una subcarpeta.\nSe puede poner un nombre personalizado, pero si se deja vacío, el nombre será 'Xomacito List'.\nSi el nombre ya existe (ej: 'Xomacito List'), se creará una nueva (ej: 'Xomacito List 01')."
        Tooltip(self.create_subfolder_checkbox, subfolder_tooltip_text, delay_ms=1000)
        # --- FIN DEL TOOLTIP ---

        self.subfolder_name_entry = ctk.CTkEntry(line2_frame, width=100, placeholder_text="Xomacito List")
    ...
    def _do_update_job_ui(self, job_id: str, status: str, message: str, progress_percent: float = 0.0):
        ...
        if status == "RUNNING":
            ...
            completed_job = self.queue_manager.get_job_by_id(job_id)
            if completed_job and completed_job.job_type in {"DOWNLOAD", "PLAYLIST"}:
    ...
    def _on_save_thumbnail_click(self):
        ...
        preservando la transparencia cuando corresponde.
        """
        ...
        try:
            ...
            print(f"ERROR: No se pudo guardar la miniatura manualmente: {e}")
    ...
    def _open_batch_output_folder(self):
        ...
        # 1. Prioridad: La subcarpeta del lote (ej: "Xomacito List 01")
