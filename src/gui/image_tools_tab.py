...
class ImageToolsTab(ctk.CTkFrame):
    ...
    def _create_bottom_panel(self):
        ...
        self.subfolder_name_entry = ctk.CTkEntry(line2_frame, width=120, placeholder_text="Xomacito Imágenes")
    ...
    def _get_temp_dir(self):
        ...
        try:
            path = os.path.join(tempfile.gettempdir(), "xomacito_images")
    ...
    def _on_start_process(self):
        ...
        if self.create_subfolder_checkbox.get():
            subfolder_name = self.subfolder_name_entry.get() or "Xomacito Imágenes"
        ...
        try:
            ...
            for i, item_data in enumerate(self.file_list_data):
                ...
                if self.process_only_new_checkbox.get() == 1 and existing_output and os.path.exists(existing_output):
                    ...
                    # Añadir a la lista de completados para combinar PDF correctamente.
    ...
    def _wait_for_file_ready(self, filepath, timeout=2.0):
        ...
        Evita usar un archivo mientras todavía se está escribiendo.
        """
        import time
