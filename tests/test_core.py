...
class XomacitoWrapperTests(unittest.TestCase):
    ...
    def test_installer_uses_direct_one_folder_runtime(self):
        ...
        self.assertIn("OutputBaseFilename=Xomacito-1.2-Setup", installer)
        self.assertIn('#define MyAppVersion "4.0.19"', installer)
        self.assertIn('#define MyAppDisplayVersion "1.2"', installer)
        ...
        self.assertIn("OutputBaseFilename=Xomacito-1.2.2-Update-Light", light_installer)
    ...
    def test_release_build_and_benchmark_scripts_are_present(self):
        ...
        self.assertIn("release\\Xomacito-1.2-Setup.exe", build_script)
        self.assertIn("release\\Xomacito-1.2.2-Update-Light.exe", build_script)
